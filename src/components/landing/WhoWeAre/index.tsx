...
export default function WhoWeAre() {
  return (
    <section className="min-h-screen flex flex-col justify-center bg-[#FDFAFF] text-[#3a3a3a] px-[48px] lg:px-[7.5rem] py-12">
      <div className="hidden lg:flex flex-col gap-y-[2rem]">
        {/* top row of images */}
        ...
        <div className="flex justify-between gap-[3.75rem]">
          <div className="w-[14rem] h-[13.5rem] flex flex-col justify-center gap-[1rem]">
            <h3 className="text-[2rem] font-bold text-left leading-snug bg-gradient-to-r from-[#E06287] to-[#765DF2] bg-clip-text text-transparent break-words">
              Who We Are
            </h3>
